...
<!--         <a href="./KAFKA" class="btn btn-link">KAFKA</a> -->
        <a href ="./Health_Check" class="btn btn-link">DemoService_Dev_Health</a>
        <a href ="./Health_Check" class="btn btn-link">DemoService_Stage_Health</a>
        <a href ="./Health_Check" class="btn btn-link">Overall_Service_Health</a>
...
<!--         <iframe src="http://localhost:3000/d/bbe/prometheus-blackbox-exporter?orgId=1&refresh=10s&from=1616033351794&to=1616036951794&var-interval=10s&var-target=All&theme=light" height="100%" width="100%"> -->
        <iframe src="http://localhost:3000/d/bbe/prometheus-blackbox-exporter?orgId=1&refresh=10s&from=1616634539861&to=1616638139861&var-interval=10s&var-target=All" width="100%" height="1500" frameborder="0"></iframe>
    </div>
<script>
